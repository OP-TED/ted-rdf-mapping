...
This section describes TED notice data samples, and the method used to generate them. At first a sampling is performed on the notices from 2021, and then on a wider set.
...
* The minimal set of the most representative notices has been selected for each Standard Form and eForms subtype.
...
==== Sampling based on Standard Form:

|===
|*Standard Form*|*nr. of notices*|*percentage of total number of notices*|*nr. of the most representative notices*
...
==== Sampling based on eForms subtype:


|===
|*eForms subtype*|*nr. of notices*|*percentage of total number of notices*|*nr. of most representative notices*
